...
export const FacebookTheme = {
  ...
  chatInputClasses: `mt-1 block w-full px-4 py-2 border-0 border-t border-t-${BORDER_COLOR}
  hover:border-t-${BORDER_COLOR} focus:outline-none focus:ring-0 focus:border-t-${BORDER_COLOR}`,
  
  contacts: {
    asideClass: "h-screen border-r border-gray-300",
